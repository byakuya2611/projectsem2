...
public class Pay {
    ...
    private List<User> listEmployee = UserDAO.getListEmployee();
    private List<User> listUser = UserDAO.getListUser();
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                for (User user : listEmployee) {
                    if(user.getId() == user_id) {
                        EmployeeHome emHome = new EmployeeHome(user_id);
                ...
                if(user_id == 1) {
                    AdminHome adHome = new AdminHome(user_id);
